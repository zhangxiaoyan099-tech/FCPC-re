...
The staged CIFAR-10 training and selection procedure is documented in
[`CIFAR10_EXPERIMENT_PLAN.md`](CIFAR10_EXPERIMENT_PLAN.md). Its configurations
are generated by `python -m scripts.generate_cifar10_experiments`.
